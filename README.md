...
I am a Ph.D. working on research related to NLP and machine learning.
...
- 📃 I have published more than 20 papers with top conferences and journals, such as <strong>ACL</strong>, <strong>EMNLP</strong>, <strong>WWW</strong>, <strong>SIGIR</strong>, <strong>ACM MM</strong>, <strong>ACM TOIS</strong>, <strong>IEEE TAC</strong>, etc.
- 📫 Please visit my [portfolio website](https://BinLiang-NLP.github.io/) for complete background and contact.
